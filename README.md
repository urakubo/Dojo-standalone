...
1. Select Dojo -> Open Dojo Folder from a dropdown menu, and specify the folder of the sample EM/segmentation dojo files. Dojo will launch as a web application.
