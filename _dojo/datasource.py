...
class Datasource(object):
  ...
  def __init__(self, mojo_dir, tmp_dir, query, input_format, output_format, sub_dir):
    ...
    self.__volume = None
    ## print 'HU Subdir: ', self.__sub_dir
    ## print 'Regular: ', '.*' + self.__sub_dir + os.sep + 'tiledVolumeDescription.xml$'
  ...
  def __setup(self):
    ...
    for root, dirs, files in os.walk(self.__mojo_dir):  
      ...
      for f in files:
        ...
        # colormap
        elif self.__colormap_file_regex.match(uf_with_dir):
        ...
        elif self.__segmentinfo_file_regex.match(uf_with_dir):
          print('Connecting to DB')
          self.__database = Database(f_with_dir)
  ...
  def get_volume(self, zoomlevel):
    '''
    '''
    print('HU Bug: DataSource.py L128 Zoomlevel: ', zoomlevel)
    zoomlevel = 0
