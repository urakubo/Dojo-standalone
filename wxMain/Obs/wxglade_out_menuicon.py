...
class MojoControlPanel(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.Bind(wx.EVT_MENU, self.SelectMojoFile, id=0)
        #####
    ...
    def __do_layout(self):
        ...
        label_1 = wx.StaticText(self.nb1_3DMerge, wx.ID_ANY, "Select one from adjacent objects")
        ...
        bitmap_3 = wx.StaticBitmap(self.nb3_2DDisconnect, wx.ID_ANY, wx.Bitmap("..\\icons\\Split3D_32.png", wx.BITMAP_TYPE_ANY))
        ...
        bitmap_4 = wx.StaticBitmap(self.nb4_3DReplace, wx.ID_ANY, wx.Bitmap("..\\icons\\Split3D_32.png", wx.BITMAP_TYPE_ANY))
        ...
        bitmap_5 = wx.StaticBitmap(self.nb5_2DReplace, wx.ID_ANY, wx.Bitmap("..\\icons\\Split3D_32.png", wx.BITMAP_TYPE_ANY))
